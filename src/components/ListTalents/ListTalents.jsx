                            ...
                            <div className="list-talents-container">
                                ...
                                <Container>
                                    <Row xs="auto">
                                        ...
                                        <Col>
                                            <Button className ="filter" style={{backgroundColor: 'rgb(64,115,158)', borderColor: 'rgb(64,115,158)'}} onClick={() => handleFilter()}>
                                                Filter
                                            </Button>
                                        </Col>
                                    </Row>
                                            ...
                                            <div className="talent-item" key={talent.id_talent}>
                                                ...
                                                }
                                                {
                                                    ...
                                                    ? <Button variant="primary"
                                                        ...
                                                        style={{ width:130, marginLeft:50, backgroundColor: 'rgb(64,115,158)', borderColor: 'rgb(64,115,158)'}}
                                                    >
                                                        評価
                                                    </Button>
                                                        : talent.status === 'review'
